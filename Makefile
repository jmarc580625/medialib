...
JS_SOURCE_LIB_FILES := $(shell find $(SOURCE_LIB_DIR) -type f -name '*.js')
CSS_SOURCE_LIB_FILES := $(shell find $(SOURCE_LIB_DIR) -type f -name '*.css')
...
JS_TARGET_BUILD_LIB_FILES := $(subst $(SOURCE_LIB_DIR)/,$(BUILD_LIB_DIR)/,$(JS_SOURCE_LIB_FILES))
CSS_TARGET_BUILD_LIB_FILES := $(subst $(SOURCE_LIB_DIR)/,$(BUILD_LIB_DIR)/,$(CSS_SOURCE_LIB_FILES))
TARGET_BUILD_LIB_FILES := $(SH_TARGET_BUILD_LIB_FILES) $(AWK_TARGET_BUILD_LIB_FILES) $(FMT_TARGET_BUILD_LIB_FILES) $(JS_TARGET_BUILD_LIB_FILES) $(CSS_TARGET_BUILD_LIB_FILES)
...
JS_TARGET_INSTALL_LIB_FILES := $(subst $(BUILD_LIB_DIR)/,$(INSTALL_LIB_DIR)/,$(JS_TARGET_BUILD_LIB_FILES))
CSS_TARGET_INSTALL_LIB_FILES := $(subst $(BUILD_LIB_DIR)/,$(INSTALL_LIB_DIR)/,$(CSS_TARGET_BUILD_LIB_FILES))
TARGET_INSTALL_LIB_FILES := $(SH_TARGET_INSTALL_LIB_FILES) $(AWK_TARGET_INSTALL_LIB_FILES) $(FMT_TARGET_INSTALL_LIB_FILES) $(JS_TARGET_INSTALL_LIB_FILES) $(CSS_TARGET_INSTALL_LIB_FILES)
...
$(BUILD_LIB_DIR)/% : $(SOURCE_LIB_DIR)/%.fmt
	cp -f $< $@
	chmod -w $@
$(BUILD_LIB_DIR)/%.js : $(SOURCE_LIB_DIR)/%.js
	cp -f $< $@
	chmod -w $@
$(BUILD_LIB_DIR)/%.css : $(SOURCE_LIB_DIR)/%.css
	cp -f $< $@
	chmod -w $@
